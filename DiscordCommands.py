...
async def ask(ctx,idMTnew: int = 0):
    ...
    if idMTnew == 0 :
        await ctx.send("`Commande pour se relier au bot.` \n Cf. https://discord.com/channels/430287489664548884/430287735928913920/453217493344059404")
    else :
...
async def help(ctx):
    ...
    embed.add_field(name="arp", value="Ping ARP, afin de lui transmettre un message de façon efficace.", inline=False)
